...
const uri = `mongodb+srv://dhrubo13051:${process.env.PASSWORD}@cluster0.wgl4i.mongodb.net/${process.env.DATABASE}?retryWrites=true&w=majority`;
...
async function run() {
  try {
    ...
    // is is to update users from googele
